    ...
    ***************************/
    ...
    document.addEventListener("swup:contentReplaced", function () {
        ...
        ***************************/
        ...
        $('.mil-menu-list li').removeClass('mil-active');
        /***************************
        ...
        ***************************/
        $(document).ready(function () {
            ...
            $(".mil-dodecahedron").clone().appendTo(".mil-animation");
            $(".mil-lines").clone().appendTo(".mil-lines-place");
            /* if($(".mil-menu-list li.mil-active").length == 0){
                $(".mil-main-menu ul li.mil-active > a").clone().appendTo(".mil-current-page");
            }else{
                $(".mil-menu-list li.mil-active > a").clone().appendTo(".mil-current-page");
            } */
        });
        /***************************
    ...
    form.addEventListener("submit", async (e) => {
       ...
       /* $("#contactForm").on("submit", function(e) {
            ...
            const formData = {
                ...
                role: $("select[name='providerparent']").val(),
                care_type: $("select[name='care_type']").val(),
            ...
            $.ajax({
                url: "https://script.google.com/macros/s/AKfycbwP1cbaxWLo1qE2WVolL9oG91om-YHg-nUlfzYm-KxS8qgaI1r-4TDEcZMbIhCFpvedyw/exec",
                method: "POST",
